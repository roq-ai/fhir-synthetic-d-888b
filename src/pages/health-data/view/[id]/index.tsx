...
import { getHealthDataById } from 'apiSdk/health-data';
import { HealthDataInterface } from 'interfaces/health-data';

function HealthDataViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('health_data', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/health-data/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem label="Height" text={data?.height} />

                <FormListItem label="Weight" text={data?.weight} />

                <FormListItem label="Blood Type" text={data?.blood_type} />

                <FormListItem label="Medical Conditions" text={data?.medical_conditions} />
