...
export function PatientListPage(props: PatientListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getPatients({
        relations: ['user', 'health_data.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('health_data', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'health_data',
          header: 'Health Data',
          accessorKey: 'health_data',
          cell: ({ row: { original: record } }: any) => record?._count?.health_data,
        }
      : null,
