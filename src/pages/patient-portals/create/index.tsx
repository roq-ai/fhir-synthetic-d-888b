...
import { createPatientPortal } from 'apiSdk/patient-portals';
...
function PatientPortalCreatePage() {
  ...
  const handleSubmit = async (values: PatientPortalInterface, { resetForm }: FormikHelpers<any>) => {
    setError(null);
    try {
      await createPatientPortal(values);
      resetForm();
