...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`FHIR Synthetic Data Display Application`}</title>

        <meta
          name="description"
          content="Welcome to FHIR Synthetic Data Display Application - Streamlining the management and display of synthetic FHIR health data. Enabling administrators to efficiently oversee patient records, and empowering patients with access to their own health data."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1576091160550-2173dba999ef?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxoZWFsdGhjYXJlfGVufDB8fHx8MTY5Mzk4MjkwMXww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`FHIR Synthetic Data Display Application`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to FHIR Synthetic Data Display Application - Streamlining the management and display of synthetic FHIR health data. Enabling administrators to efficiently oversee patient records, and empowering patients with access to their own health data.`}
            </Text>
            <Box
