## Welcome to FHIR Synthetic Data Display Application

FHIR Synthetic Data Display Application is a B2B SaaS application that was generated using [ROQ.ai](https://roq.ai/)
